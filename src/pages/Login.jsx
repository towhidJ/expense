    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden px-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground tracking-tight">TakaKhata</h1>
          <p className="text-foreground/40 text-sm mt-1">Manage your finances with ease</p>
        </div>
        ...
        <div className="bg-foreground/5 backdrop-blur-2xl border border-foreground/10 rounded-3xl p-8 shadow-2xl">
            ...
            {isSignUp && (
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-foreground/5 border border-foreground/10 rounded-xl pl-11 pr-4 py-3 text-foreground text-sm focus:outline-none focus:border-cyan-500/50 transition-colors placeholder:text-foreground/20"
                />
              </div>
            )}
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              disabled={loading}
              className="flex items-center justify-center gap-2 py-3 rounded-xl bg-foreground/5 border border-foreground/10 text-foreground text-sm font-medium hover:bg-foreground/10 transition-colors disabled:opacity-50"
            >
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="text-sm text-foreground/40 hover:text-cyan-400 transition-colors"
            >
        ...
        <ManualLinks className="mt-6 justify-center text-xs" linkClassName="text-foreground/40 hover:text-cyan-400" />
      </div>
    </div>
  );
}
